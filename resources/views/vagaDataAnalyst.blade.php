    ...
    <body>
        ...
        @endif
            ...
            <div class="div-img-DataAnalist">
                <img class="img-DataAnalist" src="../../images/vagaDataAnalyst.png">

                <form id="form-adiciona" action="{{ route('enviar_cadastro_analyst') }}" method="post" enctype="multipart/form-data">
                @csrf
